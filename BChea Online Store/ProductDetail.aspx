<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Template.Master" CodeBehind="ProductDetail.aspx.vb" Inherits="BChea_Online_Store.ProductDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <!--=====================================
                BANNER PART START
    =======================================-->
    <section class="single-banner inner-section" style="background: no-repeat center;">
        <div class="container">
            <h2><asp:Label ID="lblProductType" runat="server" Text=""></asp:Label></h2>
            <ol class="breadcrumb">
                ...
                <div class="col-lg-6">
                    <div class="details-gallery">
                        ...
                        <ul class="details-preview"> 
                            <li><asp:Image ID="imgProductImage" runat="server" /></li>
                        </ul>
                        <ul class="details-thumb">
                            <li><asp:Image ID="imgProductPreview" runat="server" /></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="details-content">
                        ...
                        <div class="details-meta">
                            <p>Prod. ID:<span><asp:Label ID="lblProductID" runat="server" Text=""></asp:Label></span></p>
                            <p>Brand: <span><asp:Label ID="lblProductBrand" runat="server" Text=""></asp:Label></span></p>
                        </div>
                        <div class="details-rating">
                            <asp:Label ID="lblProductRating" runat="server" Text=""></asp:Label>
                        </div>
                        <h3 class="details-price">
                            <del><asp:Label ID="lblOrigPrice" runat="server" Text=""></asp:Label></del>
                            <span><asp:Label ID="lblSalePrice" runat="server" Text=""></asp:Label></span>
                        </h3>
                        <p class="details-desc"><asp:Label ID="lblProductDescription" runat="server" Text=""></asp:Label></p>
                        <div class="details-list-group">
                            <label class="details-list-title">tags:</label>
                            <ul class="details-tag-list">
                                <li><a href="#"><asp:Label ID="lblProductKeyword" runat="server" Text=""></asp:Label></a></li>
                            </ul>
                        </div>
                        <div class="details-list-group">
